...
class OrderProduct extends BaseModel
{
	...
	{
		return array(
			array('id, order_id, tester_id, product_id, configurable_id, name, quantity, sku, price', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		return array(
            ...
            'status'=>array(self::HAS_ONE, 'OrderProductStatus', 'status_id'),
	...
	public function attributeLabels()
	{
		return array(
            ...
            'tester_id'       => Yii::t('OrdersModule.core', 'Исполнитель'),
	...
	public function afterDelete()
	{
        ...
        public function getTestersTests(){

		$tests = Yii::app()->db->createCommand()
				->select('name, order_id, product_id, status_id')
				->from(self::model()->tableName())
                                ->where('tester_id=' . Yii::app()->user->getId())
                                ->queryAll();
		return $tests;
	
        }
// TODO_WUD : ! [tester] query
