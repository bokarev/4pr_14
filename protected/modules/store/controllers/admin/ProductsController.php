...
class ProductsController extends SAdminController
{
	...
	public function actionUpdate($new = false)
	{
		...
		$form->additionalTabs = array(
			...
			Yii::t('StoreModule.admin','Сопутствующие Тесты и Задачи') => $this->renderPartial('_relatedProducts',array(
				'exclude'=>$model->id,
				'product'=>$model,
			),true),
	...
	public function actionRenderVariantTable()
	{
		...
		if(!$attribute)
			throw new CHttpException(404, Yii::t('StoreModule.admin', 'Ошибка загрузки задачи'));
