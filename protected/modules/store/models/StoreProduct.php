...
class StoreProduct extends BaseModel
{
	...
	public function scopes()
	{
		...
		return array(
			...
			'newest'=>array('order'=>$alias.'.created DESC'),
                        ...
                        'byTypes'=>array('group'=>$alias.'.type_id','order'=>$alias.'.type_id'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'created'                => Yii::t('StoreModule.core', 'Дата заказа'),
	 ...
	 * @static
	 * @param $status
	 * @return string formatted status paid
         * TODO_WUD : ! [order] filter paid
	 */
	public static function formatPaid($status)
	{
		return 'оплатить';
	}
