...
class StoreProductType extends BaseModel
{
	...
	public function relations()
	{
		return array(
            ...
            'testerCount'                 => array(self::STAT, 'StoreProductTypeTester', 'type_id'),
            'typeTester'                  => array(self::HAS_MANY, 'StoreProductTypeTester', 'type_id'),
            'testers'                     => array(self::MANY_MANY, 'User', 'StoreProductTypeTester(type_id, user_id)'),
		);
	}
