...
'htmlOptions'=>array('autocomplete'=>$this->createUrl('ajax/auto')),
	...
	<div class="form message-create">
		...
		<?php echo $form->textArea($msg,'text',array('cols'=>50,'rows'=>7, 'class'=>'mailbox-message-input','style'=>'width:100%;','placeholder'=>'Введите сообщение...')); ?>
		<?php echo $form->error($msg,'text'); ?>
		</div>
		<div>
		<button class="btn btn-large message-btn-reply">Отправить</button>
		</div>
	</div>
