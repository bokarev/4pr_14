...
<?php	echo ($msg->sender_id == Yii::app()->user->id)? 'Вы' : ucfirst($sender);
	echo ($first_message)? ' написал' : ' ответили'; ?></div>
...
$form=$this->beginWidget('CActiveForm', array(
	...
	<?php echo $form->error($reply,'text'); ?>
		<div class="mailbox-textarea-wrap ui-helper-clearfix">
			<textarea name="text" cols="50" rows="7" placeholder="Введите ответ..."></textarea>
		</div>
	<input type="submit" class="btn btn-large mailbox-input" value="Ответить" />
	</div>
